<?php
/*
Template Name: Location - Salton City
*/
get_header();
?>
...
<section
    ...
    <div style="max-width: 1100px; margin: 0 auto; position: relative; z-index: 10;">
        ...
        <h1 class='lux-animate' style='font-size: clamp(3.5rem, 8vw, 5.5rem); font-weight: 900; line-height: 0.95; margin-bottom: 40px; letter-spacing: -0.04em;'>Trusted Psychiatrist <br /> <span style="color: var(--brand-orange);">Near Salton City</span></h1>
        <p class='lux-animate' style='font-size: 24px; color: rgba(255, 255, 255, 0.9); margin-bottom: 70px; line-height: 1.6; max-width: 850px; margin-left: auto; margin-right: auto; font-weight: 300;'>Access world-class psychiatric care in Salton City. We bring our signature data-driven mental health protocols from the Coachella Valley to your doorstep.</p>
...
<section style="padding: 120px 20px; background: #ffffff;">
    <div
        ...
        <div class="lux-animate">
            ...
            <h2 style='font-size: 46px; font-weight: 900; color: var(--brand-dark); line-height: 1.1; margin-bottom: 35px; letter-spacing: -0.02em;'>Premier Mental Health <br /> <span style='color: var(--brand-purple);'>For Salton City Residents.</span></h2>
            <p style='font-size: 20px; line-height: 1.9; color: #4B5563; margin-bottom: 40px;'>We bridge the gap between innovation and accessibility in Salton City, ensuring that the very best neurological care is just a short drive from your home.</p>
...
<div><div style='display: flex; align-items: center; gap: 20px; margin-bottom: 30px;'><div style='height: 2px; width: 60px; background: var(--brand-orange);'></div><span style='text-transform: uppercase; font-weight: 800; letter-spacing: 4px; font-size: 13px; color: var(--brand-orange);'>Serving Salton City</span></div>
<h2 style='font-size: 42px; font-weight: 900; color: var(--brand-dark); line-height: 1.1; margin-bottom: 30px; letter-spacing: -0.02em;'>Proudly Serving the <br /><span style='color: var(--brand-purple);'>Salton City Community</span></h2>
<p style='font-size: 18px; color: #4B5563; line-height: 1.9; margin-bottom: 25px;'>From its scenic landscapes to its diverse neighborhoods, Salton City is a place where many families and professionals have found their home.</p>
<p style='font-size: 18px; color: #4B5563; line-height: 1.9; margin-bottom: 25px;'>Every resident in Salton City deserves access to mental health protocols that are as unique as they are. Our team at <a href="https://karmadocs.com/" style="color: var(--brand-purple); text-decoration: none; font-weight: 700;"><a href='https://karmadocs.com/' style='color: var(--brand-orange); text-decoration: none; font-weight: 700;'>Karma Doctors & Associates</a></a> is dedicated to precision-driven care.</p>
<p style='font-size: 18px; color: #4B5563; line-height: 1.9;'>Whether you are located in the historic center or the newer residential developments of Salton City, our nearby clinics provide a seamless path to wellness.</p></div>
<div><div style='background: var(--brand-gray); padding: 35px; border-radius: 25px; border: 1px solid #E5E7EB; margin-bottom: 20px;'><h4 style='font-size: 20px; font-weight: 900; color: var(--brand-purple); margin-bottom: 12px;'>FDA-Cleared TMS Therapy</h4><p style='color: #4B5563; font-size: 16px; line-height: 1.7;'>A non-drug, non-invasive treatment for depression and OCD available to all Salton City residents.</p></div></div></div></section>
                ...
                <div id="slidesContainer" style="position: relative; min-height: 320px;">
                    ...
                    <div class="testimonial-slide"
                        ...
                        <div
                            ...
                            <p
                                ...
                                "Growing up in Salton City, specialized mental health care was always out of reach. Now having TMS therapy available locally has been transformative for my depression. Dr. Sunder's approach is truly personalized."
                            </p>
                            <div style="display: flex; align-items: center; gap: 15px;">
                                <div
                                    ...
                                    O</div>
                                <div>
                                    <p style="font-weight: 800; color: white; font-size: 17px; margin: 0;">Olivia M.</p>
                                    <p style="color: rgba(255,255,255,0.5); font-size: 14px; margin: 0;">Salton City Resident
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="testimonial-slide"
                        ...
                        <div
                            ...
                            <p
                                style="color: rgba(255,255,255,0.9); font-size: 19px; line-height: 1.9; margin-bottom: 30px; font-style: italic;">
                                "The qEEG brain mapping was fascinating. Seeing my anxiety patterns visualized helped me understand why standard treatments never worked. Dr. Sunder's targeted protocol using advanced neuroscience changed my life."
                            </p>
                            <div style="display: flex; align-items: center; gap: 15px;">
                                <div
                                    ...
                                    F</div>
                                <div>
                                    <p style="font-weight: 800; color: white; font-size: 17px; margin: 0;">Fernando B.</p>
                                    <p style="color: rgba(255,255,255,0.5); font-size: 14px; margin: 0;">Salton City Area Resident</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="testimonial-slide"
                        ...
                        <div
                            ...
                            <p
                                style="color: rgba(255,255,255,0.9); font-size: 19px; line-height: 1.9; margin-bottom: 30px; font-style: italic;">
                                "As an Air Force veteran dealing with PTSD near the Salton Sea, finding providers who understand military trauma was critical. The team at Karma Doctors changed my life with their compassionate, evidence-based approach."
                            </p>
                            <div style="display: flex; align-items: center; gap: 15px;">
                                <div
                                    style="width: 55px; height: 55px; background: var(--brand-purple-light); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 900; font-size: 22px;">
                                    S</div>
                                <div>
                                    <p style="font-weight: 800; color: white; font-size: 17px; margin: 0;">Samuel K.</p>
                                    <p style="color: rgba(255,255,255,0.5); font-size: 14px; margin: 0;">Salton City Veteran</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="testimonial-slide"
                        ...
                        <div
                            ...
                            <p
                                style="color: rgba(255,255,255,0.9); font-size: 19px; line-height: 1.9; margin-bottom: 30px; font-style: italic;">
                                "What impressed me most about Karma Doctors is their whole-person approach. Nutrition guidance, stress management, and the right medication balance finally gave me sustainable mental health naturally."
                            </p>
                            <div style="display: flex; align-items: center; gap: 15px;">
                                <div
                                    style="width: 55px; height: 55px; background: var(--brand-orange); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 900; font-size: 22px;">
                                    G</div>
                                <div>
                                    <p style="font-weight: 800; color: white; font-size: 17px; margin: 0;">Gloria H.</p>
                                    <p style="color: rgba(255,255,255,0.5); font-size: 14px; margin: 0;">Salton City Area Resident</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="testimonial-slide"
                        ...
                        <div
                            ...
                            <p
                                style="color: rgba(255,255,255,0.9); font-size: 19px; line-height: 1.9; margin-bottom: 30px; font-style: italic;">
                                "Our daughter struggled with ADHD and behavioral issues for years. Dr. Sunder's comprehensive treatment including parent training and precise medication management helped her become a confident honors student."
                            </p>
                            <div style="display: flex; align-items: center; gap: 15px;">
                                <div
                                    style="width: 55px; height: 55px; background: var(--brand-purple-light); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 900; font-size: 22px;">
                                    J</div>
                                <div>
                                    <p style="font-weight: 800; color: white; font-size: 17px; margin: 0;">Javier R.</p>
                                    <p style="color: rgba(255,255,255,0.5); font-size: 14px; margin: 0;">Salton City Area Parent</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="faq-grid">
            ...
            <div>
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Our nearest location in Rancho Mirage is just a short 15-minute drive from central Salton City via
                            Highway
                            111. We also have offices in Palm Springs and Twentynine Palms, giving Salton City residents
                            multiple
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Absolutely. We offer secure, HIPAA-compliant telehealth appointments for patients who prefer
                            ...
                            medication
                            management, and ongoing therapy sessions. Telehealth allows Salton City residents to connect with
                            our
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        ...
                        Coverage varies by plan, so we recommend calling (951) 297-8375 to verify your specific benefits for PrTMS treatment in Salton City.
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        ...
                        At Karma Doctors, our psychiatrists integrate both approaches for comprehensive mental health care in Salton City.</p>
                    </div>
                </details>
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Yes, Karma Doctors & Associates is currently accepting new patients for anxiety treatment in Salton City.
