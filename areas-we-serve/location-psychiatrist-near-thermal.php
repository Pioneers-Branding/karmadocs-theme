<?php
/*
Template Name: Location - Thermal
*/
get_header();
?>
...
<section
    ...
    <div style="max-width: 1100px; margin: 0 auto; position: relative; z-index: 10;">
        ...
        <h1 class='lux-animate' style='font-size: clamp(3.5rem, 8vw, 5.5rem); font-weight: 900; line-height: 0.95; margin-bottom: 40px; letter-spacing: -0.04em;'>Trusted Psychiatrist <br /> <span style="color: var(--brand-orange);">Near Thermal</span></h1>
        <p class='lux-animate' style='font-size: 24px; color: rgba(255, 255, 255, 0.9); margin-bottom: 70px; line-height: 1.6; max-width: 850px; margin-left: auto; margin-right: auto; font-weight: 300;'>Data-driven, compassionate psychiatry has arrived in Thermal. We utilize the same advanced technologies and protocols found at our main clinical hubs.</p>
...
<section style="padding: 120px 20px; background: #ffffff;">
    <div
        ...
        <div class="lux-animate">
            ...
            <h2 style='font-size: 46px; font-weight: 900; color: var(--brand-dark); line-height: 1.1; margin-bottom: 35px; letter-spacing: -0.02em;'>Premier Mental Health <br /> <span style='color: var(--brand-purple);'>For Thermal Residents.</span></h2>
            <p style='font-size: 20px; line-height: 1.9; color: #4B5563; margin-bottom: 40px;'>We bridge the gap between innovation and accessibility in Thermal, ensuring that the very best neurological care is just a short drive from your home.</p>
...
<div><div style='display: flex; align-items: center; gap: 20px; margin-bottom: 30px;'><div style='height: 2px; width: 60px; background: var(--brand-orange);'></div><span style='text-transform: uppercase; font-weight: 800; letter-spacing: 4px; font-size: 13px; color: var(--brand-orange);'>Serving Thermal</span></div>
<h2 style='font-size: 42px; font-weight: 900; color: var(--brand-dark); line-height: 1.1; margin-bottom: 30px; letter-spacing: -0.02em;'>Proudly Serving the <br /><span style='color: var(--brand-purple);'>Thermal Community</span></h2>
<p style='font-size: 18px; color: #4B5563; line-height: 1.9; margin-bottom: 25px;'>Thermal represents the best of our region, combining historical roots with a modern, forward-thinking approach to community living.</p>
<p style='font-size: 18px; color: #4B5563; line-height: 1.9; margin-bottom: 25px;'>As Thermal continues to evolve, the demand for specialized, high-level psychiatric care has never been greater. <a href="https://karmadocs.com/" style="color: var(--brand-purple); text-decoration: none; font-weight: 700;"><a href='https://karmadocs.com/' style='color: var(--brand-orange); text-decoration: none; font-weight: 700;'>Karma Doctors & Associates</a></a> is proud to serve this need.</p>
<p style='font-size: 18px; color: #4B5563; line-height: 1.9;'>Whether you are located in the historic center or the newer residential developments of Thermal, our nearby clinics provide a seamless path to wellness.</p></div>
<div><div style='background: var(--brand-gray); padding: 35px; border-radius: 25px; border: 1px solid #E5E7EB; margin-bottom: 20px;'><h4 style='font-size: 20px; font-weight: 900; color: var(--brand-purple); margin-bottom: 12px;'>Culturally Sensitive Approach</h4><p style='color: #4B5563; font-size: 16px; line-height: 1.7;'>We honor Thermal's diverse community with culturally aware, bilingual-friendly services that respect every patient.</p></div></div></div></section>
                        ...
                        <div
                            ...
                            <div style="display: flex; align-items: center; gap: 15px;">
                                ...
                                <div>
                                    ...
                                    <p style="color: rgba(255,255,255,0.5); font-size: 14px; margin: 0;">Thermal Resident
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="faq-grid">
            ...
            <div>
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Our nearest location in Rancho Mirage is just a short 15-minute drive from central Thermal via
                            Highway
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Absolutely. We offer secure, HIPAA-compliant telehealth appointments for patients who prefer
                            ...
                            medication
                            management, and ongoing therapy sessions. Telehealth allows Thermal residents to connect with
                            our
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        ...
                        Coverage varies by plan, so we recommend calling (951) 297-8375 to verify your specific benefits for PrTMS treatment near Thermal.
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        ...
                        At Karma Doctors, our psychiatrists integrate both approaches for comprehensive mental health care near Thermal.</p>
                    </div>
                </details>
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Yes, Karma Doctors & Associates is currently accepting new patients for anxiety treatment near Thermal.
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        ...
                        A full course typically involves 20-30 sessions over 4-6 weeks at our nearby locations accessible from Thermal.
