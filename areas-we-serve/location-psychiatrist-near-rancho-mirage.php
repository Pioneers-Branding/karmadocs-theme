<?php
/*
Template Name: Location - Rancho Mirage
*/
get_header();
?>
...
<section
    ...
    <div style="max-width: 1100px; margin: 0 auto; position: relative; z-index: 10;">
        ...
        <h1 class='lux-animate' style='font-size: clamp(3.5rem, 8vw, 5.5rem); font-weight: 900; line-height: 0.95; margin-bottom: 40px; letter-spacing: -0.04em;'>Trusted Psychiatrist <br /> <span style="color: var(--brand-orange);">Near Rancho Mirage</span></h1>
        <p class='lux-animate' style='font-size: 24px; color: rgba(255, 255, 255, 0.9); margin-bottom: 70px; line-height: 1.6; max-width: 850px; margin-left: auto; margin-right: auto; font-weight: 300;'>Elite mental healthcare is now local to Rancho Mirage. We extend our proven Coachella Valley psychiatric excellence to serve you and your family.</p>
...
<section style="padding: 120px 20px; background: #ffffff;">
    <div
        ...
        <div class="lux-animate">
            ...
            <h2 style='font-size: 46px; font-weight: 900; color: var(--brand-dark); line-height: 1.1; margin-bottom: 35px; letter-spacing: -0.02em;'>Premier Mental Health <br /> <span style='color: var(--brand-purple);'>For Rancho Mirage Residents.</span></h2>
            <p style='font-size: 20px; line-height: 1.9; color: #4B5563; margin-bottom: 40px;'>We bridge the gap between innovation and accessibility in Rancho Mirage, ensuring that the very best neurological care is just a short drive from your home.</p>
    ...
    <div
        ...
        <div>
            ...
            <p style="font-size: 18px; color: #4B5563; line-height: 1.9; margin-bottom: 35px;">
                ...
                patients to take control of their lives. Every Rancho Mirage patient benefits from his philosophy: <em
...
<div><div style='display: flex; align-items: center; gap: 20px; margin-bottom: 30px;'><div style='height: 2px; width: 60px; background: var(--brand-orange);'></div><span style='text-transform: uppercase; font-weight: 800; letter-spacing: 4px; font-size: 13px; color: var(--brand-orange);'>Serving Rancho Mirage</span></div>
<h2 style='font-size: 42px; font-weight: 900; color: var(--brand-dark); line-height: 1.1; margin-bottom: 30px; letter-spacing: -0.02em;'>Proudly Serving the <br /><span style='color: var(--brand-purple);'>Rancho Mirage Community</span></h2>
<p style='font-size: 18px; color: #4B5563; line-height: 1.9; margin-bottom: 25px;'>The energy of Rancho Mirage is unmistakable, characterized by a spirit of innovation and a deep appreciation for top-tier quality of life.</p>
<p style='font-size: 18px; color: #4B5563; line-height: 1.9; margin-bottom: 25px;'>Navigating mental wellness shouldn't be a challenge for those in Rancho Mirage. We bridge the gap between world-class science and local accessibility, ensuring elite psychiatry is within reach for all.</p>
<p style='font-size: 18px; color: #4B5563; line-height: 1.9;'>Serving the entirety of Rancho Mirage, from the quietest suburban streets to the bustling commercial hubs, we ensure that elite psychiatric care is always a convenient drive away.</p></div>
                        ...
                        <div
                            ...
                            <div style="display: flex; align-items: center; gap: 15px;">
                                ...
                                <div>
                                    ...
                                    <p style="color: rgba(255,255,255,0.5); font-size: 14px; margin: 0;">Rancho Mirage Resident
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="faq-grid">
            ...
            <div>
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Our nearest location in Rancho Mirage is just a short 15-minute drive from central Rancho Mirage via
                            Highway
                            111. We also have offices in Palm Springs and Twentynine Palms, giving Rancho Mirage residents
                            multiple
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Absolutely. We offer secure, HIPAA-compliant telehealth appointments for patients who prefer
                            ...
                            medication
                            management, and ongoing therapy sessions. Telehealth allows Rancho Mirage residents to connect with
                            our
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        ...
                        Coverage varies by plan, so we recommend calling (951) 297-8375 to verify your specific benefits for PrTMS treatment in Rancho Mirage.
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        ...
                        At Karma Doctors, our psychiatrists integrate both approaches for comprehensive mental health care in Rancho Mirage.</p>
                    </div>
                </details>
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Yes, Karma Doctors & Associates is currently accepting new patients for anxiety treatment in Rancho Mirage.
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        ...
                        A full course typically involves 20-30 sessions over 4-6 weeks at our Rancho Mirage clinic.
