<?php
/*
Template Name: Location - Twentynine Palms
*/
get_header();
?>
...
<section
    ...
    <div style="max-width: 1100px; margin: 0 auto; position: relative; z-index: 10;">
        ...
        <h1 class='lux-animate' style='font-size: clamp(3.5rem, 8vw, 5.5rem); font-weight: 900; line-height: 0.95; margin-bottom: 40px; letter-spacing: -0.04em;'>Trusted Psychiatrist <br /> <span style="color: var(--brand-orange);">Near Twentynine Palms</span></h1>
        <p class='lux-animate' style='font-size: 24px; color: rgba(255, 255, 255, 0.9); margin-bottom: 70px; line-height: 1.6; max-width: 850px; margin-left: auto; margin-right: auto; font-weight: 300;'>Data-driven, compassionate psychiatry has arrived in Twentynine Palms. We utilize the same advanced technologies and protocols found at our main clinical hubs.</p>
...
<section style="padding: 120px 20px; background: #ffffff;">
    <div
        ...
        <div class="lux-animate">
            ...
            <h2 style='font-size: 46px; font-weight: 900; color: var(--brand-dark); line-height: 1.1; margin-bottom: 35px; letter-spacing: -0.02em;'>Elite Care Is <br /> <span style="color: var(--brand-purple);">Closer Than You Think.</span></h2>
            <p style='font-size: 20px; line-height: 1.9; color: #4B5563; margin-bottom: 40px;'>Accessing elite psychiatric intervention should never be a burden. We provide three convenient regional hubs for all families and individuals living in Twentynine Palms.</p>
    ...
    <div
        ...
        <div>
            ...
            <p style="font-size: 18px; color: #4B5563; line-height: 1.9; margin-bottom: 35px;">
                ...
                patients to take control of their lives. Every Twentynine Palms patient benefits from his philosophy: <em
...
<div><div style='display: flex; align-items: center; gap: 20px; margin-bottom: 30px;'><div style='height: 2px; width: 60px; background: var(--brand-orange);'></div><span style='text-transform: uppercase; font-weight: 800; letter-spacing: 4px; font-size: 13px; color: var(--brand-orange);'>Serving Twentynine Palms</span></div>
<h2 style='font-size: 42px; font-weight: 900; color: var(--brand-dark); line-height: 1.1; margin-bottom: 30px; letter-spacing: -0.02em;'>Proudly Serving the <br /><span style='color: var(--brand-purple);'>Twentynine Palms Community</span></h2>
<p style='font-size: 18px; color: #4B5563; line-height: 1.9; margin-bottom: 25px;'>From its scenic landscapes to its diverse neighborhoods, Twentynine Palms is a place where many families and professionals have found their home.</p>
<p style='font-size: 18px; color: #4B5563; line-height: 1.9; margin-bottom: 25px;'>Our commitment to Twentynine Palms is built on a foundation of medical excellence and compassionate support, making <a href="https://karmadocs.com/" style="color: var(--brand-purple); text-decoration: none; font-weight: 700;"><a href='https://karmadocs.com/' style='color: var(--brand-orange); text-decoration: none; font-weight: 700;'>Karma Doctors & Associates</a></a> the premier choice.</p>
<p style='font-size: 18px; color: #4B5563; line-height: 1.9;'>Our reach extends to every corner of Twentynine Palms, offering a local sanctuary for those seeking to reclaim their mental clarity.</p></div>
<div><div style='background: var(--brand-gray); padding: 35px; border-radius: 25px; border: 1px solid #E5E7EB; margin-bottom: 20px;'><h4 style='font-size: 20px; font-weight: 900; color: var(--brand-purple); margin-bottom: 12px;'>Culturally Sensitive Approach</h4><p style='color: #4B5563; font-size: 16px; line-height: 1.7;'>We honor Twentynine Palms's diverse community with culturally aware, bilingual-friendly services that respect every patient.</p></div></div></div></section>
                ...
                <div id="slidesContainer" style="position: relative; min-height: 320px;">
                    ...
                    <div class="testimonial-slide"
                        ...
                        <div
                            ...
                            <p
                                ...
                                "As a Twentynine Palms resident dealing with treatment-resistant depression, TMS therapy at Karma Doctors was a lifesaver. Dr. Sunder's personalized approach made all the difference in my recovery journey."
                            </p>
                            <div style="display: flex; align-items: center; gap: 15px;">
                                <div
                                    ...
                                    C</div>
                                <div>
                                    <p style="font-weight: 800; color: white; font-size: 17px; margin: 0;">Catherine M.</p>
                                    <p style="color: rgba(255,255,255,0.5); font-size: 14px; margin: 0;">Twentynine Palms Resident
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="testimonial-slide"
                        ...
                        <div
                            ...
                            <p
                                style="color: rgba(255,255,255,0.9); font-size: 19px; line-height: 1.9; margin-bottom: 30px; font-style: italic;">
                                "The brain mapping technology helped me understand why I'd struggled with anxiety for so long. Dr. Sunder's targeted treatment protocol using advanced neuroscience changed everything for me."
                            </p>
                            <div style="display: flex; align-items: center; gap: 15px;">
                                <div
                                    ...
                                    D</div>
                                <div>
                                    <p style="font-weight: 800; color: white; font-size: 17px; margin: 0;">David W.</p>
                                    <p style="color: rgba(255,255,255,0.5); font-size: 14px; margin: 0;">Marine Corps Air Station Resident</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="testimonial-slide"
                        ...
                        <div
                            ...
                            <p
                                style="color: rgba(255,255,255,0.9); font-size: 19px; line-height: 1.9; margin-bottom: 30px; font-style: italic;">
                                "As a Marine veteran dealing with PTSD, finding mental health care that understands military service is critical. The Twentynine Palms team at Karma Doctors helped me reclaim my life and relationships."
                            </p>
                            <div style="display: flex; align-items: center; gap: 15px;">
                                <div
                                    style="width: 55px; height: 55px; background: var(--brand-purple-light); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 900; font-size: 22px;">
                                    R</div>
                                <div>
                                    <p style="font-weight: 800; color: white; font-size: 17px; margin: 0;">Richard L.</p>
                                    <p style="color: rgba(255,255,255,0.5); font-size: 14px; margin: 0;">Twentynine Palms Veteran</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="testimonial-slide"
                        ...
                        <div
                            ...
                            <p
                                style="color: rgba(255,255,255,0.9); font-size: 19px; line-height: 1.9; margin-bottom: 30px; font-style: italic;">
                                "After cycling through countless medications, the integrative approach at Karma Doctors finally worked. Their attention to nutrition, sleep, and stress management alongside medication changed my life."
                            </p>
                            <div style="display: flex; align-items: center; gap: 15px;">
                                <div
                                    style="width: 55px; height: 55px; background: var(--brand-orange); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 900; font-size: 22px;">
                                    A</div>
                                <div>
                                    <p style="font-weight: 800; color: white; font-size: 17px; margin: 0;">Angela R.</p>
                                    <p style="color: rgba(255,255,255,0.5); font-size: 14px; margin: 0;">Wonder Valley Resident</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="testimonial-slide"
                        ...
                        <div
                            ...
                            <p
                                style="color: rgba(255,255,255,0.9); font-size: 19px; line-height: 1.9; margin-bottom: 30px; font-style: italic;">
                                "When my daughter was diagnosed with ADHD, we were desperate for help. Dr. Sunder's comprehensive treatment plan helped her excel in school and finally feel confident. Forever grateful to this practice."
                            </p>
                            <div style="display: flex; align-items: center; gap: 15px;">
                                <div
                                    style="width: 55px; height: 55px; background: var(--brand-purple-light); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 900; font-size: 22px;">
                                    K</div>
                                <div>
                                    <p style="font-weight: 800; color: white; font-size: 17px; margin: 0;">Kimberly S.</p>
                                    <p style="color: rgba(255,255,255,0.5); font-size: 14px; margin: 0;">Twentynine Palms Area Parent</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="faq-grid">
            ...
            <div>
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Our nearest location in Rancho Mirage is just a short 15-minute drive from central Twentynine Palms via
                            Highway
                            111. We also have offices in Palm Springs and Twentynine Palms, giving Twentynine Palms residents
                            multiple
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Absolutely. We offer secure, HIPAA-compliant telehealth appointments for patients who prefer
                            ...
                            medication
                            management, and ongoing therapy sessions. Telehealth allows Twentynine Palms residents to connect with
                            our
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        ...
                        Coverage varies by plan, so we recommend calling (951) 297-8375 to verify your specific benefits for PrTMS treatment in Twentynine Palms.
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        ...
                        At Karma Doctors, our psychiatrists integrate both approaches for comprehensive mental health care in Twentynine Palms.</p>
                    </div>
                </details>
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Yes, Karma Doctors & Associates is currently accepting new patients for anxiety treatment in Twentynine Palms.
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        ...
                        A full course typically involves 20-30 sessions over 4-6 weeks at our Twentynine Palms location.
...
<section style="padding: 100px 20px; background: #ffffff;">
    <div
        ...
        <div style="position: relative; z-index: 10;">
            <h2 style='font-size: clamp(2.5rem, 5vw, 3.8rem); font-weight: 900; color: white; margin-bottom: 25px; letter-spacing: -0.04em; line-height: 1.1;'>Find Your Way Back to Happiness</h2>
            <p
