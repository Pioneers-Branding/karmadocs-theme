...
<section style="padding: 120px 20px; background: #ffffff;">
    <div
        ...
        <div class="lux-animate">
            ...
            <h2 style='font-size: 46px; font-weight: 900; color: var(--brand-dark); line-height: 1.1; margin-bottom: 35px; letter-spacing: -0.02em;'>Premier Mental Health <br /> <span style='color: var(--brand-purple);'>For Indio Residents.</span></h2>
            <p style='font-size: 20px; line-height: 1.9; color: #4B5563; margin-bottom: 40px;'>We bridge the gap between innovation and accessibility in Indio, ensuring that the very best neurological care is just a short drive from your home.</p>
    ...
    <div
        ...
        <div>
            ...
            <p style="font-size: 18px; color: #4B5563; line-height: 1.9; margin-bottom: 25px;">
                ...
                90,000 residents. Known for its rich cultural heritage, the annual Coachella and Stagecoach festivals,
                and the beautiful desert landscape, Indio is a city that pulses with energy and life.
            </p>
            <p style="font-size: 18px; color: #4B5563; line-height: 1.9; margin-bottom: 25px;">
                Yet, like many fast-growing communities, access to specialized mental health care has not kept pace with
                demand. Karma Doctors & Associates is committed to bridging that gap — bringing world-class psychiatric
            ...
            <p style="font-size: 18px; color: #4B5563; line-height: 1.9;">
                Whether you're in downtown Indio, the Shadow Hills neighborhood, or the Terra Lago community, our Rancho
                Mirage office is just minutes away. We understand the unique needs of the Coachella Valley and are proud
            ...
            <div style="display: grid; gap: 20px;">
                ...
                <div
                    ...
                    <p style="color: #4B5563; font-size: 16px; line-height: 1.7;">We honor Indio's diverse community
                        with culturally aware, bilingual-friendly services that respect every patient's background.</p>
                </div>
                        ...
                        <div
                            ...
                            <div style="display: flex; align-items: center; gap: 15px;">
                                ...
                                <div>
                                    ...
                                    <p style="color: rgba(255,255,255,0.5); font-size: 14px; margin: 0;">Indio Resident
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="faq-grid">
            ...
            <div>
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Our nearest location in Rancho Mirage is just a short 15-minute drive from central Indio via
                            Highway
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Yes, Karma Doctors & Associates accepts most major insurance plans. We recommend contacting
                            our
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Absolutely. We offer secure, HIPAA-compliant telehealth appointments for patients who prefer
                            ...
                            medication
                            management, and ongoing therapy sessions. Telehealth allows Indio residents to connect with
                            our
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        ...
                        Coverage varies by plan, so we recommend calling (951) 297-8375 to verify your specific benefits for PrTMS treatment near Indio.
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        ...
                        At Karma Doctors, our psychiatrists integrate both approaches for comprehensive mental health care near Indio.</p>
                    </div>
                </details>
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Yes, Karma Doctors & Associates is currently accepting new patients for anxiety treatment near Indio.
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        ...
                        A full course typically involves 20-30 sessions over 4-6 weeks at our locations near Indio.
