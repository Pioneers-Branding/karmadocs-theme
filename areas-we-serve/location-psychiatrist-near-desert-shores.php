<?php
/*
Template Name: Location - Desert Shores
*/
get_header();
?>
...
<section
    ...
    <div style="max-width: 1100px; margin: 0 auto; position: relative; z-index: 10;">
        ...
        <h1 class='lux-animate' style='font-size: clamp(3.5rem, 8vw, 5.5rem); font-weight: 900; line-height: 0.95; margin-bottom: 40px; letter-spacing: -0.04em;'>Trusted Psychiatrist <br /> <span style="color: var(--brand-orange);">Near Desert Shores</span></h1>
        <p class='lux-animate' style='font-size: 24px; color: rgba(255, 255, 255, 0.9); margin-bottom: 70px; line-height: 1.6; max-width: 850px; margin-left: auto; margin-right: auto; font-weight: 300;'>Commitment to excellence in Desert Shores. Our team is dedicated to providing residents with the highest level of psychiatric care available in Southern California.</p>
...
<section style="padding: 120px 20px; background: #ffffff;">
    <div
        ...
        <div class="lux-animate">
            ...
            <h2 style='font-size: 46px; font-weight: 900; color: var(--brand-dark); line-height: 1.1; margin-bottom: 35px; letter-spacing: -0.02em;'>Premier Mental Health <br /> <span style='color: var(--brand-purple);'>For Desert Shores Residents.</span></h2>
            <p style='font-size: 20px; line-height: 1.9; color: #4B5563; margin-bottom: 40px;'>We bridge the gap between innovation and accessibility in Desert Shores, ensuring that the very best neurological care is just a short drive from your home.</p>
    ...
    <div
        ...
        <div>
            ...
            <p style="font-size: 18px; color: #4B5563; line-height: 1.9; margin-bottom: 35px;">
                ...
                patients to take control of their lives. Every Desert Shores patient benefits from his philosophy: <em
...
<div><div style='display: flex; align-items: center; gap: 20px; margin-bottom: 30px;'><div style='height: 2px; width: 60px; background: var(--brand-orange);'></div><span style='text-transform: uppercase; font-weight: 800; letter-spacing: 4px; font-size: 13px; color: var(--brand-orange);'>Serving Desert Shores</span></div>
<h2 style='font-size: 42px; font-weight: 900; color: var(--brand-dark); line-height: 1.1; margin-bottom: 30px; letter-spacing: -0.02em;'>Proudly Serving the <br /><span style='color: var(--brand-purple);'>Desert Shores Community</span></h2>
<p style='font-size: 18px; color: #4B5563; line-height: 1.9; margin-bottom: 25px;'>From its scenic landscapes to its diverse neighborhoods, Desert Shores is a place where many families and professionals have found their home.</p>
<p style='font-size: 18px; color: #4B5563; line-height: 1.9; margin-bottom: 25px;'>As Desert Shores continues to evolve, the demand for specialized, high-level psychiatric care has never been greater. <a href="https://karmadocs.com/" style="color: var(--brand-purple); text-decoration: none; font-weight: 700;"><a href='https://karmadocs.com/' style='color: var(--brand-orange); text-decoration: none; font-weight: 700;'>Karma Doctors & Associates</a></a> is proud to serve this need.</p>
<p style='font-size: 18px; color: #4B5563; line-height: 1.9;'>Whether you are located in the historic center or the newer residential developments of Desert Shores, our nearby clinics provide a seamless path to wellness.</p></div>
<div><div style='background: var(--brand-gray); padding: 35px; border-radius: 25px; border: 1px solid #E5E7EB; margin-bottom: 20px;'><h4 style='font-size: 20px; font-weight: 900; color: var(--brand-purple); margin-bottom: 12px;'>FDA-Cleared TMS Therapy</h4><p style='color: #4B5563; font-size: 16px; line-height: 1.7;'>A non-drug, non-invasive treatment for depression and OCD available to all Desert Shores residents.</p></div></div></div></section>
                ...
                <div id="slidesContainer" style="position: relative; min-height: 320px;">
                    ...
                    <div class="testimonial-slide"
                        ...
                        <div
                            ...
                            <p
                                ...
                                "Desert Shores is my home, and having access to TMS therapy here has been transformative for my depression. Dr. Sunder's personalized approach gave me hope when I thought there was none left."
                            </p>
                            <div style="display: flex; align-items: center; gap: 15px;">
                                <div
                                    ...
                                    N</div>
                                <div>
                                    <p style="font-weight: 800; color: white; font-size: 17px; margin: 0;">Norma R.</p>
                                    <p style="color: rgba(255,255,255,0.5); font-size: 14px; margin: 0;">Desert Shores Resident
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="testimonial-slide"
                        ...
                        <div
                            ...
                            <p
                                style="color: rgba(255,255,255,0.9); font-size: 19px; line-height: 1.9; margin-bottom: 30px; font-style: italic;">
                                "The qEEG brain mapping showed exactly why traditional treatments never worked for my anxiety. Dr. Sunder's targeted protocol using advanced neuroscience gave me my life back. Finally sleeping through the night."
                            </p>
                            <div style="display: flex; align-items: center; gap: 15px;">
                                <div
                                    ...
                                    V</div>
                                <div>
                                    <p style="font-weight: 800; color: white; font-size: 17px; margin: 0;">Victor H.</p>
                                    <p style="color: rgba(255,255,255,0.5); font-size: 14px; margin: 0;">Desert Shores Area Resident</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="testimonial-slide"
                        ...
                        <div
                            ...
                            <p
                                style="color: rgba(255,255,255,0.9); font-size: 19px; line-height: 1.9; margin-bottom: 30px; font-style: italic;">
                                "As a Marine Corps veteran, finding PTSD care that understands military service was critical. The team at Karma Doctors helped me process decades of trauma with compassion and evidence-based treatments."
                            </p>
                            <div style="display: flex; align-items: center; gap: 15px;">
                                <div
                                    style="width: 55px; height: 55px; background: var(--brand-purple-light); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 900; font-size: 22px;">
                                    T</div>
                                <div>
                                    <p style="font-weight: 800; color: white; font-size: 17px; margin: 0;">Thomas L.</p>
                                    <p style="color: rgba(255,255,255,0.5); font-size: 14px; margin: 0;">Desert Shores Veteran</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="testimonial-slide"
                        ...
                        <div
                            ...
                            <p
                                style="color: rgba(255,255,255,0.9); font-size: 19px; line-height: 1.9; margin-bottom: 30px; font-style: italic;">
                                "The whole-person approach at Karma Doctors including nutritional support, mindfulness, and medication balance finally gave me sustainable mental health without the rollercoaster of side effects I experienced before."
                            </p>
                            <div style="display: flex; align-items: center; gap: 15px;">
                                <div
                                    style="width: 55px; height: 55px; background: var(--brand-orange); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 900; font-size: 22px;">
                                    G</div>
                                <div>
                                    <p style="font-weight: 800; color: white; font-size: 17px; margin: 0;">Grace M.</p>
                                    <p style="color: rgba(255,255,255,0.5); font-size: 14px; margin: 0;">Desert Shores Area Resident</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="testimonial-slide"
                        ...
                        <div
                            ...
                            <p
                                style="color: rgba(255,255,255,0.9); font-size: 19px; line-height: 1.9; margin-bottom: 30px; font-style: italic;">
                                "Our family traveled from Thermal seeking help for our daughter's ADHD. Dr. Sunder's comprehensive treatment including behavioral therapy and careful medication management transformed her school performance and self-esteem."
                            </p>
                            <div style="display: flex; align-items: center; gap: 15px;">
                                <div
                                    style="width: 55px; height: 55px; background: var(--brand-purple-light); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 900; font-size: 22px;">
                                    D</div>
                                <div>
                                    <p style="font-weight: 800; color: white; font-size: 17px; margin: 0;">Diana S.</p>
                                    <p style="color: rgba(255,255,255,0.5); font-size: 14px; margin: 0;">Thermal Area Parent</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="faq-grid">
            ...
            <div>
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Our nearest location in Rancho Mirage is just a short 15-minute drive from central Desert Shores via
                            Highway
                            111. We also have offices in Palm Springs and Twentynine Palms, giving Desert Shores residents
                            multiple
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Absolutely. We offer secure, HIPAA-compliant telehealth appointments for patients who prefer
                            ...
                            medication
                            management, and ongoing therapy sessions. Telehealth allows Desert Shores residents to connect with
                            our
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        ...
                        Coverage varies by plan, so we recommend calling (951) 297-8375 to verify your specific benefits for PrTMS treatment in Desert Shores.
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        ...
                        At Karma Doctors, our psychiatrists integrate both approaches for comprehensive mental health care in Desert Shores.</p>
                    </div>
                </details>
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Yes, Karma Doctors & Associates is currently accepting new patients for anxiety treatment in Desert Shores.
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        ...
                        A full course typically involves 20-30 sessions over 4-6 weeks at our nearby Coachella Valley locations.
...
<section style="padding: 100px 20px; background: #ffffff;">
    <div
        ...
        <div style="position: relative; z-index: 10;">
            <h2 style='font-size: clamp(2.5rem, 5vw, 3.8rem); font-weight: 900; color: white; margin-bottom: 25px; letter-spacing: -0.04em; line-height: 1.1;'>Your Path to Wellness Starts Today</h2>
            <p
