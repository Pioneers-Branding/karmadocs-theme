<footer class="relative overflow-hidden font-sans">
    ...
    <div class="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-brand-purple to-transparent">
    </div>
    ...
    <div class="relative z-10 pt-16 pb-8" id="footer-location">
        <div class="container mx-auto px-4">
            ...
            <div class="bg-white/5 rounded-2xl p-6 md:p-8 mb-12 border border-white/10">
                <h4
                    class="text-white font-bold text-lg uppercase tracking-wider mb-6 flex items-center justify-center md:justify-start">
                    <span
                        class="w-3 h-3 bg-gradient-to-r from-brand-orange to-brand-purple rounded-full mr-3 animate-pulse"></span>
                    Our Clinic Locations & Service Areas
                </h4>
                <div class="grid md:grid-cols-3 gap-6">
                    <!-- Location 1: Palm Springs -->
                    <div
                        class="flex flex-col h-full bg-white/5 rounded-xl border border-white/10 overflow-hidden group hover:border-brand-purple/40 transition-all duration-300">
                        <div class="p-5 flex-grow">
                            <h5
                                class="text-white font-bold text-base mb-1 group-hover:text-brand-purple transition-colors flex items-center gap-2">
                        ...
                        <div class="h-48 relative overflow-hidden border-t border-white/10">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3314.925876722152!2d-116.50244922375673!3d33.81422587324756!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80db1d8e55ea98e3%3A0x807c8a665e925f92!2sKarma%20TMS%20PC%20-%20Palm%20Springs!5e0!3m2!1sen!2sin!4v1779297634613!5m2!1sen!2sin"
                    ...
                    <div
                        class="flex flex-col h-full bg-white/5 rounded-xl border border-white/10 overflow-hidden group hover:border-brand-orange/40 transition-all duration-300">
                        <div class="p-5 flex-grow">
                            <h5
                                class="text-white font-bold text-base mb-1 group-hover:text-brand-orange transition-colors flex items-center gap-2">
                        ...
                        <div class="h-48 relative overflow-hidden border-t border-white/10">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d429.135153608562!2d-116.40525242845216!3d33.79133854907109!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80dafd05ddc703a3%3A0x891f7551331b4071!2sBrain%20Tune%20TMS%20-%20Rancho%20Mirage!5e0!3m2!1sen!2sin!4v1779297581443!5m2!1sen!2sin"
                                width="100%" height="100%" style="border:0; position: absolute; inset: 0;"
                                allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
                            </iframe>
                        </div>
                    ...
                    <div
                        ...
                        <div class="h-48 relative overflow-hidden border-t border-white/10">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3302.410883346241!2d-116.07819942374508!3d34.13582867312575!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80dac751d31242d7%3A0x7d17d9e80e8a6f1a!2sKarma%20TMS%20PC%20-%2029%20Palms!5e0!3m2!1sen!2sin!4v1779297610649!5m2!1sen!2sin"
                                width="100%" height="100%" style="border:0; position: absolute; inset: 0;"
                                allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
                            </iframe>
                        </div>
            ...
            <div class="grid md:grid-cols-12 gap-8 lg:gap-12">
                ...
                <div class="md:col-span-4 lg:col-span-4">
                    ...
                    <p class="text-gray-400 text-sm leading-relaxed mb-6 max-w-xs">
                        Providing top-tier psychiatric care and TMS therapy with a compassionate, integrative
                        approach. Your journey to wellness starts here.
                    </p>

                    <!-- Social Links -->
                    <!-- <div class="flex gap-3">
                            <a href="#"
                                class="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 text-sm transition-colors hover:bg-brand-purple hover:border-brand-purple hover:text-white">
                    ...
                    <div class="mt-8 space-y-3">
                        ...
                        <a href="mailto:contact@karmadocs.com"
                            class="flex items-center gap-3 text-sm text-gray-400 hover:text-white transition-colors group">
                            <div
                                class="w-8 h-8 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-brand-purple group-hover:bg-brand-purple group-hover:text-white transition-colors flex-shrink-0">
                ...
                <div class="md:col-span-2 lg:col-span-2">
                    ...
                    <ul class="space-y-3">
                        <li><a href="<?php echo home_url('/'); ?>"
                                class="text-gray-400 text-sm hover:text-white transition-colors">Home</a>
                        </li>
                ...
                <div class="md:col-span-2 lg:col-span-2">
                    ...
                    <ul class="space-y-3">
                        <li><a href="<?php echo home_url('/depression'); ?>"
                                class="text-gray-400 text-sm hover:text-white transition-colors">Depression</a></li>
                        <li><a href="<?php echo home_url('/anxiety'); ?>"
                                class="text-gray-400 text-sm hover:text-white transition-colors">Anxiety</a>
                        </li>
                        <li><a href="<?php echo home_url('/ptsd'); ?>"
                                class="text-gray-400 text-sm hover:text-white transition-colors">PTSD</a>
                        </li>
                        <li><a href="<?php echo home_url('/adhd'); ?>"
                                class="text-gray-400 text-sm hover:text-white transition-colors">ADHD</a>
                        </li>
                        <li><a href="<?php echo home_url('/bipolar'); ?>"
                                class="text-gray-400 text-sm hover:text-white transition-colors">Bipolar
                                Disorder</a>
                        </li>
                        <li><a href="<?php echo home_url('/ocd'); ?>"
                                class="text-gray-400 text-sm hover:text-white transition-colors">OCD</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="md:col-span-4 lg:col-span-4">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-start gap-4 p-3 rounded-xl bg-white/5 border border-white/5">
                            <div
                                class="w-10 h-10 rounded-lg bg-brand-purple/20 flex items-center justify-center flex-shrink-0">
                        ...
                        <div class="flex items-start gap-4 p-3 rounded-xl bg-white/5 border border-white/5">
                            <div
                                class="w-10 h-10 rounded-lg bg-brand-orange/20 flex items-center justify-center flex-shrink-0">
            ...
            <?php get_template_part('template-parts/areas-we-serve-links'); ?>
