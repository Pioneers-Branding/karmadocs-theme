            ...
            <div class="mt-20 pt-10 border-t border-gray-200">
                ...
                <div class="grid sm:grid-cols-2 gap-6">
                    ...
                    <div
                        ...
                        <p class="text-sm text-gray-500 leading-snug">560 S Paseo Dorotea, Suite 4-A<br>Palm
                            Springs, CA 92264</p>
                    </div>
                    <!-- Loc 2 -->
                    <div
                        ...
                        <p class="text-sm text-gray-500 leading-snug">35400 Bob Hope Dr. Suite 206-A<br>Rancho Mirage,
                            CA 92270</p>
                    </div>
                    <!-- Loc 3 -->
                    <div
                        ...
                        <p class="text-sm text-gray-500 leading-snug">72724 29 Palms Hwy. Suite 107-A<br>Twentynine
                            Palms, CA 92277</p>
                    </div>
                </div>
            </div>
